...
?>
									...
									<div class="right">
										<button type="button" class="btn" data-toggle="modal" data-target="#exampleModal"><i class="inr inr-plus-circle"></i>Tambah Data</button>
								...
								<div class="panel-body">
									<table class="table table-hover">
										...
										<tbody>
											...
											<td>
												<a href="/absensi/{{$absensi->id}}/edit" class="btn-warning btn-sm">Edit</a>
									            <a href="/absensi/{{$absensi->id}}/delete" class="btn-danger btn-sm" onclick="return confirm('yakin akan di hapus?')">Delete</a>
											</td>
										</tr>
										@endforeach
																	</tbody>
